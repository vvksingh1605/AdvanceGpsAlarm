...
import com.example.mahesh.alarmlocator.adapter.TextWatcherAdapter;


/**
 * Created by sis116 on 05-Sep-16.
 */
public class ClearableAutocompleteview extends AutoCompleteTextView implements OnTouchListener, OnFocusChangeListener, TextWatcherAdapter.TextWatcherListener {
    ...
    public ClearableAutocompleteview(Context context) {
        super(context);
        init();
    }

    public ClearableAutocompleteview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ClearableAutocompleteview(Context context, AttributeSet attrs, int defStyle) {
